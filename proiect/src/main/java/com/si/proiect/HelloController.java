...
public class HelloController {
    ...
    protected void onEncryptButtonClick() {
        if (selectedFile == null) {
            statusLabel.setText("Eroare: Te rog selecteaza un fisier mai intai!");
            return;
        }

        Algorithm selectedAlgorithm = algComboBox.getSelectionModel().getSelectedItem();
        if (selectedAlgorithm == null) {
            statusLabel.setText("Eroare: Selecteaza un algoritm pentru criptare!");
            return;
        }
        ...
        try {
            ...
            file.setFilePath(outputPathOpenSSL);
            ...
            alert.setHeaderText("Fisier criptat cu succes!");
            alert.setContentText("Cheia generata este: " + databaseKey);
            alert.showAndWait();
    ...
    protected void onSelectFileClick() {
        ...
        fileChooser.setTitle("Alege fisierul pentru criptare");
